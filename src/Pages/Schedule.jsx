...
const Schedule = () => {
    ...
    piketGroup = [
        ["Dzaky", "Damar", "Adam", "Rendi", "Iqbal", "Kesya", "Aufa"],
        ["Asyifa", "Fadil", "Andika", "Sendi", "Ibnu", "Bintang", "Defa"],
        ["Bahrul", "Sidiq", "Trio", "Rifai", "Zainal", "Duta"],
        ["Azura", "Rohim", "Depiyan", "Ahdan", "Afandi", "Arelga"],
        ["Siska", "Vero", "Fajar", "Kanjeng", "Riski", "Adit", "Rokhis"],
    ]
